...
for (let index = 0; index < universities.length; index++) {
  if(universities[index].indexOf("Uni") !== -1){
...
*/
const largerPopulation = zooAnimals.filter(population => population.population < 5);
...
const populationTotal = population.reduce((total, amount) => total + amount);
